...
class GuestAdapter(context: Context, private val guestList : List<Guest>,private val act : AppCompatActivity) : ArrayAdapter<String>(context, R.layout.guest_list_menu, guestList as List<String>)
{
